    ...
    return (
        <>
            <IonMenu contentId="gym-dashboard-main-page" className={"gym_owner_dashboard_main_menu"}>
                <IonHeader className={"theme_bg"}>
                    <IonToolbar className={"theme_secondary_color"}>
                        <IonTitle className={"ion-text-left header-title heading"}>Menu</IonTitle>
                    </IonToolbar>
                </IonHeader>
                <IonContent className={"theme_secondary_color ion-padding"}>
                    <IonGrid onClick={()=>replacePage('/dashboard/home')}>
                    ...
                    <IonGrid onClick={()=>goToPage('/dashboard/member')}>
                        <IonRow className={"dashboard_test_with_svg main_text"}>
                            <IonCol size={2} className={"ion-text-left"}>
                    ...
                    <IonGrid>
                        <IonRow className={"dashboard_test_with_svg main_text"}>
                            <IonCol size={2} className={"ion-text-left"}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30px" viewBox="0 0 24 24" fill="#ffffff"><g><path fill="none" d="M0 0h24v24H0z"/><path d="M21 11.646V21a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-9.354A3.985 3.985 0 0 1 2 9V3a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v6c0 1.014-.378 1.94-1 2.646zM14 9a1 1 0 0 1 2 0 2 2 0 1 0 4 0V4H4v5a2 2 0 1 0 4 0 1 1 0 1 1 2 0 2 2 0 1 0 4 0z"/></g></svg>
                            </IonCol>
                            <IonCol size={10}>
                                Store
                            </IonCol>
                    ...
                    <IonGrid>
                        <IonRow className={"dashboard_test_with_svg main_text"}>
                            <IonCol size={2} className={"ion-text-left"}>
                                <svg width="30px" viewBox="0 0 24 24" fill={"#ffffff"}><path d="M11.5 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6.5-6v-5.5c0-3.07-2.13-5.64-5-6.32V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5v.68c-2.87.68-5 3.25-5 6.32V16l-2 2v1h17v-1l-2-2z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
                            </IonCol>
                            <IonCol size={10}>
                                Notifications
                            </IonCol>
                    ...
                    <IonGrid>
                        <IonRow className={"dashboard_test_with_svg main_text"}>
                            <IonCol size={2} className={"ion-text-left"}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30px" viewBox="0 0 24 24" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M12.4277 2C11.3139 2 10.2995 2.6007 8.27081 3.80211L7.58466 4.20846C5.55594 5.40987 4.54158 6.01057 3.98466 7C3.42773 7.98943 3.42773 9.19084 3.42773 11.5937V12.4063C3.42773 14.8092 3.42773 16.0106 3.98466 17C4.54158 17.9894 5.55594 18.5901 7.58466 19.7915L8.27081 20.1979C10.2995 21.3993 11.3139 22 12.4277 22C13.5416 22 14.5559 21.3993 16.5847 20.1979L17.2708 19.7915C19.2995 18.5901 20.3139 17.9894 20.8708 17C21.4277 16.0106 21.4277 14.8092 21.4277 12.4063V11.5937C21.4277 9.19084 21.4277 7.98943 20.8708 7C20.3139 6.01057 19.2995 5.40987 17.2708 4.20846L16.5847 3.80211C14.5559 2.6007 13.5416 2 12.4277 2ZM8.67773 12C8.67773 9.92893 10.3567 8.25 12.4277 8.25C14.4988 8.25 16.1777 9.92893 16.1777 12C16.1777 14.0711 14.4988 15.75 12.4277 15.75C10.3567 15.75 8.67773 14.0711 8.67773 12Z" fill="#ffffff"/></svg>
                            </IonCol>
                            <IonCol size={10}>
                                Settings
                            </IonCol>
...
export default OwnerMainDashboardMenu;